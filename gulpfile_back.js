...
// gulp.task('generate-headers', (done) => {
//     const headers = [];
//     const walk = (dir) => {
...
//         if (stat.isDirectory()) {
//             walk(fullPath);
//         } else if (file.endsWith('.br') || file.endsWith('.gz')) {
//             const encoding = file.endsWith('.br') ? 'br' : 'gzip';
//             const original = fullPath.replace(/\.br$|\.gz$/, '').replace(path.resolve('dist'), '');
